            ...
            <div className='border rounded-md'>
                ...
                <div className='flex items-center justify-between p-4'>
                    <div className='flex items-center gap-8'>
                        <div className='font-semibold text-[14px]'><span className='text-xs font-normal tracking-wide'>Order Id :</span> 124535</div>
                        <div className='font-semibold text-[14px]'><span className='text-xs font-normal tracking-wide'>Order Date :</span>  4 Sep</div>
                    </div>
                    <div className='font-semibold text-[14px]'><span className='text-xs font-normal tracking-wide'>Total Price :</span>  $1785</div>
                </div>
                <hr />
                <div className='p-2 space-x-4 flex items-center'>
                    <span className='border p-1 rounded-full text-xl font-semibold'><CiDeliveryTruck /></span>
                    <p className='text-yellow-500 text-sm font-semibold'>Handed Over to Customer</p>
                </div>
                ...
                <div className='p-2'>
                    ...
                    <div className='flex items-center justify-between p-2'>
                        <div className='flex flex-col gap-1 text-sm'>
                            <span className='font-semibold'>Track your order in few seconds</span>
                            <span className='text-xs'>1800-111-111</span>
                        </div>
                        <div>
                            <button className='text-sm px-3 py-1 rounded bg-gray-700 text-white hover:bg-gray-800'>Track Order</button>
                        </div>
                    </div>
                    <hr />
                    ...
                    <div className='space-y-2'>
                        <div className='text-sm'>
                            <div className='flex items-center gap-6 p-2'>
                                <p><span className='font-semibold tracking-wide'><TiTick className='inline '/>Size :</span>135 mm</p>
                                <p className='font-semibold tracking-wide'><TiTick className='inline '/>Power Submitter</p>
                            </div>
                        </div>
                        <div>
