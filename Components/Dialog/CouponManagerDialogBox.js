    ...
    <div className="relative border tracking-wide space-y-5 rounded-md shadow-lg h-[calc(100%-1rem)] max-h-full">
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2">
            ...
            <TextField label="Quantity" name="quantity" id="quantity" size="small" {...register("quantity")} sx={{minWidth:300}}/> 
        </div>
        <div className="flex items-center justify-between gap-2">
            <TextField label="Price" name="price" id="price" size="small" {...register("price")} sx={{minWidth:300}}/>
            <TextField label="Percentage" name="percentage" id="percentage" size="small" {...register("percentage")} sx={{minWidth:300}}/>
        </div>
