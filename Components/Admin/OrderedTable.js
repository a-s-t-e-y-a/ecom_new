...
const data = [
  {OrderDate:"01/01/2012  02:30 pm",OrderId:235,Name: "Ajit Kumar Singh ",CoupneCode:"free200",Amount: "Rs300",Mobile: 123456987 ,Prescription:"Yes"},
  {OrderDate:"01/01/2012  02:30 pm",OrderId:235,Name: "Ajit Kumar Singh ",CoupneCode:"free200",Amount: "Rs300",Mobile: 123456987 ,Prescription:"Yes"},
  {OrderDate:"01/01/2012  02:30 pm",OrderId:235,Name: "Ajit Kumar Singh ",CoupneCode:"free200",Amount: "Rs300",Mobile: 123456987 ,Prescription:"Yes"},
  {OrderDate:"01/01/2012  02:30 pm",OrderId:235,Name: "Ajit Kumar Singh ",CoupneCode:"free200",Amount: "Rs300",Mobile: 123456987 ,Prescription:"Yes"},
  {OrderDate:"01/01/2012  02:30 pm",OrderId:235,Name: "Ajit Kumar Singh ",CoupneCode:"free200",Amount: "Rs300",Mobile: 123456987 ,Prescription:"Yes"},
        ...
        <tbody className='text-xs text-gray-600 text-center overflow-scroll mt-10'>
          {
            ...
            <td className="border border-slate-300 py-2">
              <div className='flex items-center justify-center gap-3 text-md '>
                <span className='text-lg text-blue-600 cursor-pointer'><BiShowAlt /></span>
                <span className='text-lg text-orange-600 cursor-pointer'><MdDelete /></span>
              </div>
            </td>
          </tr>
            ))
