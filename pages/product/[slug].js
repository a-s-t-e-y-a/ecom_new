    ...
    <Layout>
      ...
      <section className="text-gray-600">
        ...
        <div className="flex flex-col">
          <div className="font-bold text-black text-lg rounded-md shadow-lg">
            Related Products
          </div>
          ...
          <button className="bg-gray-300 my-4 absolute ml-18 rounded-lg flex justify-center items-center w-[10%] text-blue-600 py-2">
            See More
          </button>
        </div>
