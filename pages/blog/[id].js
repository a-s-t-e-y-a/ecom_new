        ...
        <div className='w-full mt-4'>
            <div className='border w-[60%] mx-auto p-3'>
                <div className='space-y-5'>
                    <div>
                    <h1 className="text-3xl tracking-wide font-bold text-center">Tech Diaries | Ankit Mantri, Supply Chain Product Manager manager to my manager</h1>
                    <div></div>
                    </div>
